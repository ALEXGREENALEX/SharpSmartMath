...
namespace OpenToolkit.Mathematics
{
    ...
    public static class MathHelper
    {
        ...
        /// </summary>
        /// <param name="a">The first of two doubles to compare.</param>
        /// <param name="b">The second of two doubles to compare.</param>
        /// <returns>Parameter a or b, whichever is larger.</returns>
        [Pure]
        ...
        public static int HammingWeight(uint value)
        {
            int count = 0;
            while (value != 0)
            {
        ...
        /// </summary>
        /// <param name="x">Bitfield to find LSB in.</param>
        /// <returns>Return the number of the least significant set bit.</returns>
        public static int FindLSB(int x)
        {
            int i;
            int mask;
            int res = -1;
        ...
        /// <summary>
        /// Returns the bit number of the most significant bit (value of 1) in the bitfield x.
        /// If the number is negative then the position of the first zero bit is returned.
        /// If no bits have the value 1 (or 0 in the negative case) then -1 is returned. 
        /// </summary>
        /// <param name="x">Bitfield to find MSB in.</param>
        /// <returns>Return the number of the most significant bit.</returns>
        ...
        public static void frexp(double value, out double mantissa, out int exponent)
        {
